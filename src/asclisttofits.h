...
*				asclisttoldac.h
*
* Include file for asclisttoldac.c.
*
*%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
*
...
#define         VERSION         "1.x"
#define         DATE            "2011-11-14"
#define		THREADS_NMAX	16              /* max. number of threads */
#endif

/*------------------------ what, who, when and where ------------------------*/

#define         BANNER		"ASCListtoLDAC"
...
static char	imagepath[MAXCHAR];

/*------------------------------- initialization ----------------------------*/
keystruct       objkey[] = {
  {"ALPHA_J2000", "Right ascension of image center (J2000)",
        &alpha, H_FLOAT, T_DOUBLE, "%11.7f", "deg",
        "pos.eq.ra;pos.barycenter;meta.main", "deg"},
  {"DELTA_J2000", "Declination of image center (J2000)",
        &delta, H_FLOAT, T_DOUBLE, "%+11.7f", "deg",
        "pos.eq.dec;pos.barycenter;meta.main", "deg"},
  {"IMAGE_PATH", "Image path",
        imagepath, H_STRING, T_STRING, "%s", "",
        "meta.id", "", 1}};
